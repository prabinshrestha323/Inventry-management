...
<?php
 ...
 $id = $_GET['id'];
 $supplier = mysqli_query($con,"SELECT * FROM `product_supplier` WHERE id = '$id'");
  ...
  <table class="table table-condensed">
  	...
  	<tr>
  		<td>
	  		...
	  		<div class="has-primary has-feedback">
		      <div>
		        <input type="text" class="form-control" name="email" value="<?php echo $row['semail']; ?>" required>
  		...
  		<td>
	  		...
	  		<div class="has-primary has-feedback">
		      <div>
		        <input type="text" class="form-control" name="contact" value="<?php echo $row['scontact']; ?>" required>
   ...
   if (isset($_SESSION['update_message'])) {
    ...
    ?>
				...
				if (isset($_GET['delete'])) { 
					...
					<?php
						$id=$_GET['id'];
						$delete = mysqli_query($con,"DELETE FROM `product_supplier` WHERE id='$id'");
					 }else{
					?>
				  ...
				  <div class="alert alert-info">
				    <strong>Info!</strong> Are you sure you want to delete this supplier? If yes just click the <label class="label label-xs label-danger">Delete</label> button and if not just close the window. <i>You can not undo this function.</i>
				  </div>
				  ...
				  <table class="table table-condensed">
				  	...
				  	<tr>
				  		<td>
					  		<label>Email: </label><?php echo $row['semail']; ?>
				  		</td>
				  		<td>
					  		<label>Contact: </label><?php echo $row['scontact']; ?>
				  		</td>
				  		<td>
				  			<label></label><br/>
